...
public class MeleeFragilityInfusion extends DebuffInfusion {
    @Override
    ...
    public String getDescription() {
        return "Take (1.1^level) more damage from melee.";
    }

    @Nullable
    @Override
    public String getExtendedDescription(int level) {
        return String.format("Take %.1f%% more melee damage.", 1 - Math.pow(1.1, level) * 100);
    }
    ...
    class DamageListener implements Listener {
        ...
        public void onDamage(EntityDamageEvent event) {
            ...
            int level = InfusionUtils.accumulateInfusionLevelOf(player, MeleeFragilityInfusion.this);
